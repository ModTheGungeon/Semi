...
namespace SGUI {
    ...
    public interface ISGUIBackend {
        ...
        /// <summary>
        /// Releases all resource used by the <see cref="SGUI.ISGUIBackend"/> object.
        /// </summary>
        /// <remarks>Call <see cref="Dispose()"/> when you are finished using the <see cref="SGUI.ISGUIBackend"/>. The
        /// <see cref="Dispose()"/> method leaves the <see cref="SGUI.ISGUIBackend"/> in an unusable state. After
        /// calling <see cref="Dispose()"/>, you must release all references to the <see cref="SGUI.ISGUIBackend"/> so
        /// the garbage collector can reclaim the memory that the <see cref="SGUI.ISGUIBackend"/> was occupying.</remarks>
        void Dispose();
