...
namespace Semi.DebugConsole {
    public partial class Console {
        ...
        private static Dictionary<Logger.LogLevel, Color> _LoggerColors = new Dictionary<Logger.LogLevel, Color> {
            {Logger.LogLevel.Debug, new Color(10/255f, 222/255f, 0/255f)},
            {Logger.LogLevel.Info, new Color(0/255f, 173/255f, 238/255f)},
            {Logger.LogLevel.Warn, new Color(237/255f, 160/255f, 0/255f)},
            {Logger.LogLevel.Error, new Color(255/255f, 31/255f, 31/255f)}
        };
        ...
        internal void AddDefaultCommands() {
            ...
            AddGroup("debug")
                ...
                .WithSubCommand("character", (args) => {
                    if (args.Count < 1) throw new Exception("At least 1 argument required.");
					SemiLoader.ConsoleController.StartCoroutine(_ChangeCharacter(args[0], args.Count > 1));
...
//                        return Registry.Items.RandomKey;
            ...
            AddCommand("summon", (args) => {
                ...
                var entity = AIActor.Spawn(Registry.Enemies[id], cell, player.CurrentRoom, true, AIActor.AwakenAnimationType.Default, true);
